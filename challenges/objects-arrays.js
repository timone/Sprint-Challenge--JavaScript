...
*/
const animalNames = []
zooAnimals.forEach((arr, index) => animalNames.push(`Name: ${arr.animal_name}, Scientific: ${arr.scientific_name}.`))
...
*/
const largerPopulation = zooAnimals.filter((arr) => arr.population <= 5)
